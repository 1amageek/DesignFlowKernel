...
| Foundation-first storage | Expose `makeArtifactReference` and `registerArtifact` with `CircuiteFoundation` types; reject non-canonical artifact records at the storage boundary. |
