...
public enum FlowRunResumeError: Error, Equatable, LocalizedError {
    ...
    case planProjectionMismatch(String)
    ...
    public var errorDescription: String? {
        ...
        case .planProjectionMismatch(let runID):
            "Run cannot be resumed because the ledger plan does not match the digest-bound plan artifact: \(runID)"
