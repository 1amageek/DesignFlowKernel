...
public struct XcircuiteAgentLoopProfileValidator: Sendable {
    public init() {}

    public func validate(_ profile: XcircuiteAgentLoopProfile) throws {
    ...
    private func validateBudgets(_ budgets: XcircuiteAgentLoopProfile.Budgets) throws {
