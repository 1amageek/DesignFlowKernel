...
public struct XcircuiteAgentLoopProfile: Sendable, Hashable, Codable {
    ...
    public struct ApprovalThreshold: Sendable, Hashable, Codable {
        ...
        public var minimumSeverity: XcircuiteRunGuardSeverity

        public init(
            operationKind: String,
            minimumSeverity: XcircuiteRunGuardSeverity = .warning
        ) {
    ...
    public struct ResumePolicy: Sendable, Hashable, Codable {
        public var allowedStatuses: [XcircuiteRunStatus]
        public var requireFreshSnapshot: Bool
        public var requireGuardVerdict: Bool

        public init(
            allowedStatuses: [XcircuiteRunStatus] = [.created, .partial, .blocked, .failed],
