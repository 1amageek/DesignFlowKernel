...
| Foundation-first execution storage | Complete | `FlowExecutionStorage.makeArtifactReference` and `registerArtifact` expose canonical `ArtifactReference` values; progress artifacts use only the canonical API. |
